...
<head>
	...
	<title>Heru Portfolio - Home</title>
	<!-- Bootstrap CSS -->
				...
				<div class="row align-items-center justify-content-between">
					<div class="col-lg-6">
						<div class="banner_content">
							<h3>Hey There !</h3>
							<h1 class="text-uppercase">I am Heru Kristanto</h1>
							<h5 class="text-uppercase">Backend Developer & Software Developer</h5>
							...
							<a class="primary_btn" href="https://docs.google.com/uc?export=download&id=0B0VhyFSJaBgAUFZYRVNnY01CeE1TVnFZR3VsMnhjcHJXNWlV"><span>See My Work</span></a>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="home_right_img">
							<img class="img-fluid" src="img/banner/home-right1.png" alt="">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-blog">
						...
						<div class="short_details">
							...
							<a href="https://app1-tweet.herokuapp.com/" class="primary_btn2">Learn More</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="single-blog">
						...
						<div class="short_details">
							...
							<a href="https://app-0033.herokuapp.com/" class="primary_btn2">Learn More</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="single-blog">
						...
						<div class="short_details">
							...
							<a href="https://spk-hotel.herokuapp.com/wisatawan/public/listdata.php" class="primary_btn2">Learn More</a>
						</div>
					</div>
				</div>
			</div>
