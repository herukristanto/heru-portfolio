...
<head>
	...
	<title>Heru Portfolio - Contact</title>
	<!-- Bootstrap CSS -->
        ...
        <div class="col-lg-4">
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3>Bojonegoro, Indonesia.</h3>
              <p>Bojonegoro,  Kode Pos: 62155</p>
            </div>
          </div>
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
            <div class="media-body">
              <h3><a href="tel:081319570033">0813 1957 0033</a></h3>
              <p>Call us your query anytime!</p>
            </div>
          </div>
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-email"></i></span>
            <div class="media-body">
              <h3><a href="herukristanto90@gmail.com">herukristanto90@gmail.com</a></h3>
